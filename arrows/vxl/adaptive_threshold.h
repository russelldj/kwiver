...
#ifndef KWIVER_ADAPTIVE_THRESHOLD_
#define KWIVER_ADAPTIVE_THRESHOLD_
...
class KWIVER_ALGO_VXL_EXPORT adaptive_threshold
  : public vital::algo::image_filter
{
public:
  PLUGIN_INFO( "vxl_adaptive_threshold",
               "Threshold at image at a given percentile." )

  adaptive_threshold();
  virtual ~adaptive_threshold();
